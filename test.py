import unittest
from parse_log import open_file, convert_hour
from parse_log import total_time, file_to_dict, parse_dict
...
class test_parse(unittest.TestCase):
    ...
    def test_file_to_dict(self):
        ...
        self.assertEqual(file_to_dict(["19:00-20:00 Test3","14:00-15:00 Test4"]), \
            {"Test3": 60, "Test4":60})
